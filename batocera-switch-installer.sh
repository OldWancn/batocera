...
wget -q -O "$path/batocera-switch-updater.sh" "https://raw.githubusercontent.com/OldWancn/batocera/main/batocera-switch-updater.sh"
...
wget -q -O "/tmp/batocera-switch-updater.sh" "https://raw.githubusercontent.com/OldWancn/batocera/main/batocera-switch-updater.sh" 
